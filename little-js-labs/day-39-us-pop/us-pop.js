...
function greaterTwentyKDifferenceMaleToFemale (data) {

  var filtered = data.filter(function(item) {

    if (Math.abs(item.females - item.males) > 20000){
      return true;
    } else {
      return false;
    }
...
var result = lessThanOneHundredKPop(dataset);
...
function greaterTwentyKDifferenceRemoveCountryAndYear (data) {
...
function lessThanOneHundredKPopAddDifference (data) {
