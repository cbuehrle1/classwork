...
function moreFemaleThanMale (data){
  var output = []
...
var result = moreMaleThanFemale(dataset);

// console.log(result);

// Refactor those into one function

function moreSexThanTheOther (data, greater, less){
  var output =[]
...
var result = moreSexThanTheOther(dataset, "males", "females");
...
var result = sumOfFemales(dataset);
...
function sumOfGender (data, gender){
  var output = 0;
...
var result = sumOfGender(dataset, "males")
...
var result = femalesAbove65(dataset);

// console.log(result);

// Refactor those into one function

function genderAbove65(data, gender){
...
var result = genderAbove65(dataset, "males")
