...
function kingsNamedSeleucus (data) {
  ...
  var filtered = data.rulers.filter(function(item) {
...
function rulersWhoReignedMoreThanFiveYears (data) {
...
var result = rulersWhoReignedMoreThanFiveYears(dataset);

// console.log(result);

// Write a function that returns the rulers who reigned more than twenty years. Requirement: use filter.

function rulersWhoReignedMoreThanTwentyYears(data) {
...
var result = rulersWhoReignedMoreThanTwentyYears(dataset);

// console.log(result);

// Write a function that returns rulers without consorts. Requirement: use filter.

function noConsorts(data) {
...
function rulersreignedMoreThanFiveYearsWithNewProp(data) {
  ...
  var output = filtered.map(function(item){
    return {name: item.name,
            startReign: item.startReign,
            endReign: item.endReign,
            lengthOfReign: item.startReign - item.endReign,
...
var result = rulersreignedMoreThanFiveYearsWithNewProp(dataset);
