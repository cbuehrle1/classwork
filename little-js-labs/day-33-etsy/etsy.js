...
var result = avgItemPrice(items);

// console.log(result)

// Get all the items that cost between $14.00 and $18.00 USD

function itemsBtwn14And18 (data){
  var output = []
...
var result = madeOfWood(items);
//
// console.log(result)

// Find which items are made of eight or more materials.

function moreThanEigthMaterials(data){
  var output = [];
...
var result = moreThanEigthMaterials(items);

// console.log(result)

// Return the items that were made by their sellers

function madeBySeller (data){
  var output = []
