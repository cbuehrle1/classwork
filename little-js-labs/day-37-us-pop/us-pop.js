...
function returnTheFemales (data) {
...
var result = returnTheMales(dataset);
...
function removeCountyAndYear (data) {
...
function addDifferenceBetweenGenderPopulation (data) {
  ...
  var output = data.map(function(age){
    ...
    return {
      ...
      females: age.females,
      males: age.males,
      differenceFemaleToMale: age.females - age.males,
      total: age.total
    };
...
var result = addDifferenceBetweenGenderPopulation(dataset);
